...
test = pd.read_csv('Test_IMSI_all_used.csv',encoding = 'utf-8') #contain the test IMSI
df =pd.read_csv('Q2Cloud.csv',encoding = 'utf-8') # contain the features we used for prediction
a = df.copy()
# two features' set prediction
